...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private final LatLng mDefaultLocation = new LatLng(38.561956, -121.424203);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(csus).title("Marker in CSUS"));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(csus, zoomLevel));(*/
    }
    ...
    public LatLng getAddress(String strAddress) {
        ...
        try {
            ...
            int count = 0;
            while(p1 == null && count < address.size()){
                Address location = address.get(count);
                p1 = new LatLng(location.getLatitude(), location.getLongitude());
                count ++;
            }
